...
class Puzzle:
    ...
    def tilt_all(self, matrix, direction):
        ...
        if direction == "north":
            for i in range(matrix_0_len):
                ...
                result = [
                    item
                    for sublist in splitted_lines
                    for item in self.tilt(sublist, "l")
                ]
            ...
            for i in range(matrix_0_len):
                ...
                result = [
                    item
                    for sublist in splitted_lines
                    for item in self.tilt(sublist, "r")
                ]
                tilted.append(result)
                tilted_final = list(map(list, zip(*tilted)))
        elif direction == "east":
    ...
    def solve(self, part):
        ...
        return sum(
            [
                row.count("O") * (len(self.tilted) - i)
                for i, row in enumerate(self.tilted)
            ]
        )
